            ...
            ${this.showThemePicker?u`
                  <div class="theme-picker">
                    ${Object.values(q).map(a=>u`
                        <div
                          class="theme-option ${this.theme===a.name?"active":""}"
                          data-theme="${a.name}"
                          @click=${()=>this.setTheme(a.name)}
                          title="${a.label}"
                        ></div>
                      `)}
                  </div>
        ...
        ${r.map(a=>u`
            <article class="result">
              <div class="result-url">
                ${a.parsed_url?a.parsed_url.join(" > "):a.url}
              </div>
              <h3 class="result-title">
                <a href="${a.url}" target="_blank" rel="noopener noreferrer">${a.title}</a>
              </h3>
              ${a.content?u`<p class="result-snippet">${a.content}</p>`:""}
              ${a.engine?u`<span class="result-engine">${a.engine}</span>`:""}
            </article>
          `)}
      </main>
